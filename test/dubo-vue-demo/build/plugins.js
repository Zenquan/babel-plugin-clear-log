...
const isDirectoryChanged = process.env.NODE_ENV === 'production' && (checkFilesChange(resolve('src/assets/'), resolve('build/scripts/assets-hash.txt')) || (
  resolve('dist/assets'), resolve('build/scripts/assets-hash.txt')
));
